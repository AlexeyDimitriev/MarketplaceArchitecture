...
- Feed Service. Владеет данными о рекомендациях. Отвечает за подбор товаров в ленте рекомендаций
- Notifications Service. Владеет данными об уведомлениях. Отвечает за уведомление покупателей о статусе заказа
